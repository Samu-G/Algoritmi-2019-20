...
void insertion_sort_test_su_record(int selector, int print)
{
  ...
  case 1:
    ...
    insertion_sort(ptr, n_of_record, record_int_cmp);
  ...
  case 2:
    ...
    insertion_sort(ptr, n_of_record, record_float_cmp);
  ...
  case 3:
    ...
    insertion_sort(ptr, n_of_record, record_string_cmp);
  ...
  if (print == 1)
  {
    Record *rr_sorted = record_new(n_of_record);

    for (int i = 0; i < n_of_record; i++)
      record_insert(rr_sorted, i, ((Record *)ptr[i])->field1, ((Record *)ptr[i])->field2, ((Record *)ptr[i])->field3);

    record_print(rr_sorted, n_of_record);

    record_remove(rr_sorted);
  }
...
void quick_sort_test_su_record(int selector, int print)
{
  ...
  case 1:
    ...
    quick_sort(ptr, n_of_record, record_int_cmp);
  ...
  case 2:
    ...
    quick_sort(ptr, n_of_record, record_float_cmp);
  ...
  case 3:
    ...
    quick_sort(ptr, n_of_record, record_string_cmp);
