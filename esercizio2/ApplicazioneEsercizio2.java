...
/**
 * This class is an application of how the editDistance function can be used to
 * find, given a lexically incorrect text, a pool of words that come closest to
 * the incorrect word, using a vocabulary given as input to the program. Created
 * by the developers Samuel Girardello & Marius Berinde.
 */
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    for (int i = 0; i < sentenceList.size(); i++) {
      ...
      if (minEditDistance == 0) {
        ...
        System.out.print("List of words with minor editDistance (equal to " + minEditDistance + ") for the word <"
            + sentenceList.get(i) + ">:");
    ...
    System.out
        .println("\n\n----------------------------------------------------------------------------------------------");
    System.out.println("Analyzed a text of " + sentenceList.size() + " words referring to a dictionary of "
        + dictionaryList.size() + " words in a time of " + (float) elapsedTime / 1000000000 + " seconds");
    System.out
        .println("----------------------------------------------------------------------------------------------\n\n");
    sentenceList.clear();
